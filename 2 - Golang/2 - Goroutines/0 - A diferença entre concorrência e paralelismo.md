_Concorrência_ não é _paralelismo_. _Paralelismo_ é quando duas ou mais _threads_ executam o código simultaneamente através de diferentes cores do processador.
